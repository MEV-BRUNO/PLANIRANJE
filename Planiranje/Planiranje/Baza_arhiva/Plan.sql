...
CREATE TABLE nastavnik_obrazac (
  ...
  Predmet text,
  Supervizor text,
  Nastavnik_pocetnik int(20) NOT NULL,
  Mjesovita_dobna_skupina int(20) NOT NULL,
  Br_ucenika_razred int(20) NOT NULL,
  Br_stanovnika_zajednica int(20) NOT NULL,
  Br_ucenika_skola int(20) NOT NULL,
  Dobna_skupina text,
  Postotak_ucenika_obitelj text,
  Postotak_ucenika_jezik text,  
  Koriste_li_se_cesto_udzbenici text,
  Pokrivaju_li_udzbenici_i_metode text,
  Jesu_li_udzbenici_i_metode_poucavanja text,
  Koliko_se_sati_na_tjedan_posvecuje text,
  Koliko_se_ucenika_koristi_postupcima text,
  Koliko_se_puta_godisnje_testiraju_postignuca text,
  Dijagnosticira_li_nastavnik_probleme_u_ucenju text,
  Ima_li_nastavnik_propisane_nastavne_planove text,
  Provodi_li_nastavnik_propisane_planove text,  
