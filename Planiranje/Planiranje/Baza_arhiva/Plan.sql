...
CREATE TABLE nastavnik_obrazac (
  ...
  Predmet text,
  Supervizor text,
  Nastavnik_pocetnik int NOT NULL,
  Mjesovita_dobna_skupina int NOT NULL,
  Br_ucenika_razred int NOT NULL,
  Br_stanovnika_zajednica int NOT NULL,
  Br_ucenika_skola int NOT NULL,
  Dobna_skupina text,
