...
namespace Planiranje.Models
{
    public class OS_Plan_1_DBHandle 
    {
        ...
        public List<OS_Plan_1> DohvatiOS_Plan_1()
        {
            connection();
            ...
            {
                cmd.Connection = con;
                cmd.CommandText = "SELECT id_plan, naziv, ak_godina, opis FROM OS_Plan_1 where id_pedagog = " + AppSession.Current.UserId + " ORDER BY id_plan ASC";
                con.Open();
